...
@section('content')
        <a href="{{ route('eixo.create') }}" class="btn btn-primary mt-1">
        ...
        <a href="{{ route('eixo.graph') }}" class="btn btn-warning mt-1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('eixo.destroy', $item->id) }}" style="display: inline;" method="POST">
                            @csrf
                            @method('DELETE')
